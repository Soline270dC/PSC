...
class TimeWGAN(ModelTimeGAN):
    ...
    def __init__(self):
        super().__init__()
        self.critic = None
        self.parameters = {"lr_g": 1e-5, "lr_c": 1e-5, "lr_e": 5e-3, "lr_r": 5e-3, "epochs": 100, "batch_size": 32, "latent_dim": 100, "hidden_dim": 128, "seq_length": 10, "n_critic": 2, "lambda_gp": 0.1, "variance_coeff": 0}
